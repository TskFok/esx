...
export function buildOverviewDiagnosticActions(status: ClusterOverviewSnapshot): DiagnosticAction[] {
...
export function buildOperationsDiagnosticActions(status: OperationsStatusSnapshot): DiagnosticAction[] {
  const actions: DiagnosticAction[] = [];
...
export function appendStatusHistorySnapshot(
...
export function buildStatusTrendSummary(history: OperationsStatusSnapshot[]): StatusTrendSummary | null {
